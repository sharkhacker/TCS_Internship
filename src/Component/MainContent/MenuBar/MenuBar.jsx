...
function MenuBar({ data, setVariant, active, setActive }) {
  ...
  const handleButtonClick = () => {
    window.open("https://scribehow.com/embed/How_to_Create_a_Stock_and_Flow_Model_with_Multiple_Elements_Actions_and_features__BxKIPZgLRT-cuVHVXGy5Cg?as=scrollable&skipIntro=true", "_blank");
  };
    ...
    <>
      <Panel position="top-left">
        ...
        >
          ...
          <button className="btn btn-light" onClick={handleButtonClick}> User Documentation</button>
        </div>
      </Panel>
